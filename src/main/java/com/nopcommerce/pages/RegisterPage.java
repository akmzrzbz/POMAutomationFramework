...
public class RegisterPage extends BasePage {
    ...
    private By dobDays=By.name("DateOfBirthDay");
    ...
    public HomePage  registerNewUser(String gender,String firstName,String lastName,String day,String month,String year,String email,String company,
                                String password){
        ...
        elementUtil.doSendKeys(dobDays,day);
        elementUtil.doSendKeys(dobMonth,month);
        elementUtil.doSendKeys(dobYear,year);
        elementUtil.doSendKeys(this.email,elementUtil.randomString(7)+email);;//k3lo4c6+j@yahoo.com=k3lo4c6j@yahoo.com
